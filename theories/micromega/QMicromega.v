...
Definition Qeval_op2 (b:bool) :  Op2 ->  Q -> Q -> Tauto.rtyp b:=
  if b as b0 return (Op2 -> Q -> Q -> Tauto.rtyp b0)
  then Qeval_pop2 else Qeval_bop2.


Lemma Qeval_op2_hold : forall b op q1 q2,
    Tauto.hold b (Qeval_op2 b op q1 q2) <-> Qeval_pop2 op q1 q2.
Proof.
  destruct b.
  simpl ; tauto.
...
Definition Qeval_formula (e:PolEnv Q) (b:bool) (ff : Formula Q) :=
  let (lhs,o,rhs) := ff in Qeval_op2 b o (Qeval_expr e lhs) (Qeval_expr e rhs).
...
Definition cnfQ (Annot:Type) (TX:bool -> Type)  (AF: Type) (b: bool) (f: TFormula (Formula Q) Annot TX AF b) :=
  rxcnf qunsat qdeduce (Qnormalise Annot) (Qnegate Annot) true f.

Definition QTautoChecker  (f : BFormula (Formula Q) true) (w: list QWitness)  : bool :=
