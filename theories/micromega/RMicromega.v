...
Definition Reval_op2 (b:bool) :  Op2 ->  R -> R -> Tauto.rtyp b:=
  if b as b0 return (Op2 -> R -> R -> Tauto.rtyp b0)
...
Definition Reval_formula (e: PolEnv R) (b:bool) (ff : Formula Rcst) :=
  let (lhs,o,rhs) := ff in Reval_op2 b o (Reval_expr e lhs) (Reval_expr e rhs).
...
Definition QReval_formula (e: PolEnv R) (b:bool) (ff : Formula Q) :=
  let (lhs,o,rhs) := ff in Reval_op2 b o (QReval_expr e lhs) (QReval_expr e rhs).
...
Definition RTautoChecker (f : BFormula (Formula Rcst) true) (w: list RWitness)  : bool :=
