...
let is_navigation_vernac = function
  | VernacPure (VernacResetInitial | VernacResetName _ | VernacBack _) -> true
  | _ -> false

(* NB: Reset is now allowed again as asked by A. Chlipala *)
let is_reset = function
  | VernacPure (VernacResetInitial | VernacResetName _) -> true
  | _ -> false
...
let is_undo = function
  | VernacPure (VernacUndo _ | VernacUndoTo _) -> true
  | _ -> false
