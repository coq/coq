...
val search_by_head : ?ontop:Lemmas.t -> int option -> constr_pattern -> DirPath.t list * bool
                  -> display_function -> unit
val search_rewrite : ?ontop:Lemmas.t -> int option -> constr_pattern -> DirPath.t list * bool
                  -> display_function -> unit
val search_pattern : ?ontop:Lemmas.t -> int option -> constr_pattern -> DirPath.t list * bool
                  -> display_function -> unit
val search_about   : ?ontop:Lemmas.t -> int option -> (bool * glob_search_about_item) list
...
val interface_search : ?ontop:Lemmas.t -> ?glnum:int -> (search_constraint * bool) list ->
  constr coq_object list

(** {6 Generic search function} *)

val generic_search : ?ontop:Lemmas.t -> int option -> display_function -> unit
