...
val search_by_head : ?pstate:Lemmas.t -> int option -> constr_pattern -> DirPath.t list * bool
                  -> display_function -> unit
val search_rewrite : ?pstate:Lemmas.t -> int option -> constr_pattern -> DirPath.t list * bool
                  -> display_function -> unit
val search_pattern : ?pstate:Lemmas.t -> int option -> constr_pattern -> DirPath.t list * bool
                  -> display_function -> unit
val search_about   : ?pstate:Lemmas.t -> int option -> (bool * glob_search_about_item) list
...
val interface_search : ?pstate:Lemmas.t -> ?glnum:int -> (search_constraint * bool) list ->
  constr coq_object list

(** {6 Generic search function} *)

val generic_search : ?pstate:Lemmas.t -> int option -> display_function -> unit
