...
.. tacn:: cbn {? @reductions } @simple_occurrences
   ...
   :tacn:`cbn` is a variant of :tacn:`cbn` implemented as an abstract machine.
   ...
   .. example::
      ...
      Here are typical examples showing a difference or absence of
      difference between :tacn:`cbn` and :tacn:`simpl`:
