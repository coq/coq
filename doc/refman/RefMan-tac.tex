...
\subsection[assumption]{{\tt assumption}
\tacindex{assumption}}
...
\subsection[refine]{\tt refine \term
\tacindex{refine}
\label{refine}
...
{\tt (\_:}{\it type}{\tt )}) in the term. {\tt refine} will generate as
...
\subsection[apply in]{{\tt apply {\term} in {\ident}}
...
\subsection[constructor]{\tt constructor \num
\label{constructor}
\tacindex{constructor}}
...
\subsection[intros]{\tt intros {\intropattern} {\ldots} {\intropattern}
...
\subsection[clear]{\tt clear {\ident}
\tacindex{clear}
\label{clear}}
...
\item \texttt{clear}
  ...
  This tactic clears all hypotheses except the ones the goal depends on.
...
\subsection[revert]{\tt revert  \ident$_1$ \dots\ \ident$_n$
\tacindex{revert}
\label{revert}}
...
\subsection[move]{\tt move {\ident$_1$} after {\ident$_2$}
\tacindex{move}
\label{move}}
...
\subsection[rename]{\tt rename {\ident$_1$} into {\ident$_2$}
\tacindex{rename}}
...
\subsection[set]{{\tt set ( {\ident} {\tt :=} {\term} \tt )}
\label{tactic:set}
\tacindex{set}
\tacindex{pose}
\tacindex{remember}}
...
\subsection[decompose]{\tt decompose [ {\qualid$_1$} \dots\ {\qualid$_n$} ] \term
\label{decompose}
\tacindex{decompose}}
...
\subsection[assert]{{\tt assert ( {\ident} : {\form} \tt )}
\tacindex{assert}}
...
\subsection[generalize]{\tt generalize \term
\tacindex{generalize}
\label{generalize}}
...
\subsection[evar]{\tt evar (\ident:\term)
\tacindex{evar}
\label{evar}}
...
\subsection[instantiate]{\tt instantiate (\num:= \term)
\tacindex{instantiate}
\label{instantiate}}
...
\subsection[absurd]{\tt absurd \term
\tacindex{absurd}
\label{absurd}}
...
\subsection[contradiction]{\tt contradiction
\label{contradiction}
...
\subsection[contradict]{\tt contradict \ident}
\label{contradict}
\tacindex{contradict}
...
\subsection[destruct]{\tt destruct \term
\tacindex{destruct}}
\label{destruct}
...
\subsection[induction]{\tt induction \term
\tacindex{induction}}
...
\subsection[double induction]{\tt double induction \ident$_1$ \ident$_2$}
...
\subsection[dependent induction]{\tt dependent induction \ident
...
\subsection[functional induction]{\tt functional induction (\qualid\ \term$_1$ \dots\ \term$_n$).
...
\subsection[discriminate]{\tt discriminate {\term}
\label{discriminate}
...
\subsection[injection]{\tt injection {\term}
\label{injection}
\tacindex{injection}
\tacindex{einjection}}
...
\subsection[inversion]{\tt inversion {\ident}
\tacindex{inversion}}
...
\subsection[cofix]{\tt cofix {\ident}
\tacindex{cofix}
\label{tactic:cofix}}
