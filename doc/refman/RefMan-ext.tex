...
\subsection{Printing details of records and inductives}
\optindex{Printing Records Desugared}

By default, only the high-level details of records and inductives are
printed. The command
\begin{quote}
{\tt Set Printing Records Desugared.}
\end{quote}
shows more details when records and inductives are printed. The default
behavior may be enabled with
\begin{quote}
{\tt Unset Printing Records Desugared.}
\end{quote}
...
\item {\tt Set Printing Records Desugared.}
