  ...
  let div_eucl a b =
    ...
    | Zpos a' ->
      (match b with
       ...
       | Zneg b' -> let q0,r = pos_div_eucl a' (Zpos b') in (match r with
                                                             | Z0 -> (opp q0),Z0
                                                             | _ -> (opp (add q0 (Zpos XH))),(add b r)))
    | Zneg a' ->
      (match b with
       | Z0 -> Z0,a
       | Zpos _ -> let q0,r = pos_div_eucl a' b in (match r with
                                                    | Z0 -> (opp q0),Z0
...
let rec peq ceqb p p' =
  ...
  | PX (p2, i, q0) ->
    (match p' with
     | PX (p'0, i', q') -> (match Coq_Pos.compare i i' with
...
(** val psubI :
    ('a1 -> 'a1 -> 'a1) -> ('a1 -> 'a1) -> ('a1 pol -> 'a1 pol -> 'a1 pol) -> 'a1 pol -> positive -> 'a1 pol -> 'a1 pol **)
  ...
  (match p with
   ...
   | Pinj (j, q0) ->
     (match j with
      ...
      | XO j0 -> PX (p'0, i', (padd cO cadd ceqb (Pinj ((Coq_Pos.pred_double j0), q0)) q'))
      | XH -> PX (p'0, i', (padd cO cadd ceqb q0 q')))
   | PX (p2, i, q0) ->
     (match Z.pos_sub i i' with
      | Z0 -> mkPX cO ceqb (padd cO cadd ceqb p2 p'0) i (padd cO cadd ceqb q0 q')
      | Zpos k -> mkPX cO ceqb (padd cO cadd ceqb (PX (p2, k, (p0 cO))) p'0) i' (padd cO cadd ceqb q0 q')
      | Zneg k -> mkPX cO ceqb (paddX cO ceqb (padd cO cadd ceqb) p'0 k p2) i (padd cO cadd ceqb q0 q')))
...
| PX (p'0, i', q') ->
  (match p with
   ...
   | Pinj (j, q0) ->
     (match j with
      | XI j0 -> PX ((popp copp p'0), i', (psub cO cadd csub copp ceqb (Pinj ((XO j0), q0)) q'))
      | XO j0 -> PX ((popp copp p'0), i', (psub cO cadd csub copp ceqb (Pinj ((Coq_Pos.pred_double j0), q0)) q'))
      | XH -> PX ((popp copp p'0), i', (psub cO cadd csub copp ceqb q0 q')))
   | PX (p2, i, q0) ->
     (match Z.pos_sub i i' with
      | Z0 -> mkPX cO ceqb (psub cO cadd csub copp ceqb p2 p'0) i (psub cO cadd csub copp ceqb q0 q')
      | Zpos k -> mkPX cO ceqb (psub cO cadd csub copp ceqb (PX (p2, k, (p0 cO))) p'0) i' (psub cO cadd csub copp ceqb q0 q')
      | Zneg k -> mkPX cO ceqb (psubX cO copp ceqb (psub cO cadd csub copp ceqb) p'0 k p2) i (psub cO cadd csub copp ceqb q0 q')))
...
let rec pmulC_aux cO cmul ceqb p c =
  ...
  | PX (p2, i, q0) -> mkPX cO ceqb (pmulC_aux cO cmul ceqb p2 c) i (pmulC_aux cO cmul ceqb q0 c)
...
| PX (p', i', q') ->
  (match j with
   | XI j' -> mkPX cO ceqb (pmulI cO cI cmul ceqb pmul0 q0 j p') i' (pmulI cO cI cmul ceqb pmul0 q0 (XO j') q')
   | XO j' -> mkPX cO ceqb (pmulI cO cI cmul ceqb pmul0 q0 j p') i' (pmulI cO cI cmul ceqb pmul0 q0 (Coq_Pos.pred_double j') q')
   | XH -> mkPX cO ceqb (pmulI cO cI cmul ceqb pmul0 q0 XH p') i' (pmul0 q' q0))
  ...
  (match p with
   ...
   | Pinj (j, q0) ->
     let qQ' =
       ...
       | XO j0 -> pmul cO cI cadd cmul ceqb (Pinj ((Coq_Pos.pred_double j0), q0)) q'
   ...
   | PX (p2, i, q0) ->
     ...
     padd cO cadd ceqb (mkPX cO ceqb (padd cO cadd ceqb (mkPX cO ceqb pP' i (p0 cO)) qP') i' (p0 cO)) (mkPX cO ceqb pQ' i qQ'))
...
| PX (p2, i, q0) ->
  let twoPQ = pmul cO cI cadd cmul ceqb p2 (mkPinj XH (pmulC cO cI cmul ceqb q0 (cadd cI cI))) in
  let q2 = psquare cO cI cadd cmul ceqb q0 in
  let p3 = psquare cO cI cadd cmul ceqb p2 in mkPX cO ceqb (padd cO cadd ceqb (mkPX cO ceqb p3 i (p0 cO)) twoPQ) i q2
...
| XI p3 ->
  subst_l (pmul cO cI cadd cmul ceqb (ppow_pos cO cI cadd cmul ceqb subst_l (ppow_pos cO cI cadd cmul ceqb subst_l res p p3) p p3) p)
| XO p3 -> ppow_pos cO cI cadd cmul ceqb subst_l (ppow_pos cO cI cadd cmul ceqb subst_l res p p3) p p3
...
| PEadd (pe1, pe2) ->
  (match pe1 with
   | PEopp pe3 ->
     psub cO cadd csub copp ceqb (norm_aux cO cI cadd cmul csub copp ceqb pe2) (norm_aux cO cI cadd cmul csub copp ceqb pe3)
   | _ ->
     (match pe2 with
      | PEopp pe3 ->
        psub cO cadd csub copp ceqb (norm_aux cO cI cadd cmul csub copp ceqb pe1) (norm_aux cO cI cadd cmul csub copp ceqb pe3)
      | _ -> padd cO cadd ceqb (norm_aux cO cI cadd cmul csub copp ceqb pe1) (norm_aux cO cI cadd cmul csub copp ceqb pe2)))
| PEsub (pe1, pe2) ->
  psub cO cadd csub copp ceqb (norm_aux cO cI cadd cmul csub copp ceqb pe1) (norm_aux cO cI cadd cmul csub copp ceqb pe2)
| PEmul (pe1, pe2) ->
  pmul cO cI cadd cmul ceqb (norm_aux cO cI cadd cmul csub copp ceqb pe1) (norm_aux cO cI cadd cmul csub copp ceqb pe2)
| PEopp pe1 -> popp copp (norm_aux cO cI cadd cmul csub copp ceqb pe1)
| PEpow (pe1, n0) -> ppow_N cO cI cadd cmul ceqb (fun p -> p) (norm_aux cO cI cadd cmul csub copp ceqb pe1) n0
...
| FF k -> FF k
| X (k, p) -> X (k, p)
| A (k, a, t1) -> A (k, (fct a), t1)
| AND (k0, f1, f2) -> AND (k0, (map_bformula k0 fct f1), (map_bformula k0 fct f2))
| OR (k0, f1, f2) -> OR (k0, (map_bformula k0 fct f1), (map_bformula k0 fct f2))
| NOT (k0, f0) -> NOT (k0, (map_bformula k0 fct f0))
| IMPL (k0, f1, a, f2) -> IMPL (k0, (map_bformula k0 fct f1), a, (map_bformula k0 fct f2))
| IFF (k0, f1, f2) -> IFF (k0, (map_bformula k0 fct f1), (map_bformula k0 fct f2))
| EQ (f1, f2) -> EQ ((map_bformula IsBool fct f1), (map_bformula IsBool fct f2))
...
| [] -> (match deduce (fst t1) (fst t1) with
         | Some u -> if unsat u then None else Some (t1::[])
         | None -> Some (t1::[]))
| t'::cl0 ->
  (match deduce (fst t1) (fst t') with
   | Some u -> if unsat u then None else (match add_term unsat deduce t1 cl0 with
                                          | Some cl' -> Some (t'::cl')
                                          | None -> None)
   | None -> (match add_term unsat deduce t1 cl0 with
              | Some cl' -> Some (t'::cl')
              | None -> None))

(** val or_clause :
    ('a1 -> bool) -> ('a1 -> 'a1 -> 'a1 option) -> ('a1, 'a2) clause -> ('a1, 'a2) clause -> ('a1, 'a2) clause option **)

let rec or_clause unsat deduce cl1 cl2 =
  match cl1 with
  | [] -> Some cl2
  | t1::cl -> (match add_term unsat deduce t1 cl2 with
               | Some cl' -> or_clause unsat deduce cl cl'
               | None -> None)

(** val xor_clause_cnf : ('a1 -> bool) -> ('a1 -> 'a1 -> 'a1 option) -> ('a1, 'a2) clause -> ('a1, 'a2) cnf -> ('a1, 'a2) cnf **)

let xor_clause_cnf unsat deduce t1 f =
  fold_left (fun acc e -> match or_clause unsat deduce t1 e with
                          | Some cl -> cl::acc
                          | None -> acc) f []
...
let or_clause_cnf unsat deduce t1 f =
  match t1 with
  | [] -> f
  | _::_ -> xor_clause_cnf unsat deduce t1 f
...
let rec or_cnf unsat deduce f f' =
  match f with
  | [] -> cnf_tt
  | e::rst -> rev_append (or_cnf unsat deduce rst f') (or_clause_cnf unsat deduce e f')
...
let and_cnf_opt f1 f2 =
  if if is_cnf_ff f1 then true else is_cnf_ff f2 then cnf_ff else if is_cnf_tt f2 then f1 else and_cnf f1 f2

(** val or_cnf_opt : ('a1 -> bool) -> ('a1 -> 'a1 -> 'a1 option) -> ('a1, 'a2) cnf -> ('a1, 'a2) cnf -> ('a1, 'a2) cnf **)

let or_cnf_opt unsat deduce f1 f2 =
  if if is_cnf_tt f1 then true else is_cnf_tt f2 then cnf_tt else if is_cnf_ff f2 then f1 else or_cnf unsat deduce f1 f2
...
let mk_and unsat deduce rEC k pol0 f1 f2 =
  if pol0 then and_cnf_opt (rEC pol0 k f1) (rEC pol0 k f2) else or_cnf_opt unsat deduce (rEC pol0 k f1) (rEC pol0 k f2)
...
let mk_or unsat deduce rEC k pol0 f1 f2 =
  if pol0 then or_cnf_opt unsat deduce (rEC pol0 k f1) (rEC pol0 k f2) else and_cnf_opt (rEC pol0 k f1) (rEC pol0 k f2)
...
let mk_impl unsat deduce rEC k pol0 f1 f2 =
  if pol0 then or_cnf_opt unsat deduce (rEC (negb pol0) k f1) (rEC pol0 k f2) else and_cnf_opt (rEC (negb pol0) k f1) (rEC pol0 k f2)
...
let mk_iff unsat deduce rEC k pol0 f1 f2 =
  or_cnf_opt unsat deduce (and_cnf_opt (rEC (negb pol0) k f1) (rEC false k f2)) (and_cnf_opt (rEC pol0 k f1) (rEC true k f2))
...
| X (_, _) -> cnf_ff
| A (_, x, t1) -> if pol0 then normalise1 x t1 else negate0 x t1
| AND (k0, e1, e2) -> mk_and unsat deduce (fun x x0 x1 -> xcnf unsat deduce normalise1 negate0 x x0 x1) k0 pol0 e1 e2
| OR (k0, e1, e2) -> mk_or unsat deduce (fun x x0 x1 -> xcnf unsat deduce normalise1 negate0 x x0 x1) k0 pol0 e1 e2
| NOT (k0, e) -> xcnf unsat deduce normalise1 negate0 (negb pol0) k0 e
| IMPL (k0, e1, _, e2) -> mk_impl unsat deduce (fun x x0 x1 -> xcnf unsat deduce normalise1 negate0 x x0 x1) k0 pol0 e1 e2
| IFF (k0, e1, e2) ->
  (match is_bool k0 e2 with
   | Some isb -> xcnf unsat deduce normalise1 negate0 (if isb then pol0 else negb pol0) k0 e1
   | None -> mk_iff unsat deduce (fun x x0 x1 -> xcnf unsat deduce normalise1 negate0 x x0 x1) k0 pol0 e1 e2)
| EQ (e1, e2) ->
  (match is_bool IsBool e2 with
   | Some isb -> xcnf unsat deduce normalise1 negate0 (if isb then pol0 else negb pol0) IsBool e1
   | None -> mk_iff unsat deduce (fun x x0 x1 -> xcnf unsat deduce normalise1 negate0 x x0 x1) IsBool pol0 e1 e2)

(** val radd_term :
    ('a1 -> bool) -> ('a1 -> 'a1 -> 'a1 option) -> ('a1 * 'a2) -> ('a1, 'a2) clause -> (('a1, 'a2) clause, 'a2 trace) sum **)

let rec radd_term unsat deduce t1 = function
| [] ->
  (match deduce (fst t1) (fst t1) with
   | Some u -> if unsat u then Inr (Push ((snd t1), Null)) else Inl (t1::[])
   | None -> Inl (t1::[]))
| t'::cl0 ->
  (match deduce (fst t1) (fst t') with
   | Some u ->
     if unsat u
     then Inr (Push ((snd t1), (Push ((snd t'), Null))))
     else (match radd_term unsat deduce t1 cl0 with
           | Inl cl' -> Inl (t'::cl')
           | Inr l -> Inr l)
   | None -> (match radd_term unsat deduce t1 cl0 with
              | Inl cl' -> Inl (t'::cl')
              | Inr l -> Inr l))
...
let rec ror_clause unsat deduce cl1 cl2 =
  match cl1 with
  | [] -> Inl cl2
  | t1::cl -> (match radd_term unsat deduce t1 cl2 with
...
let xror_clause_cnf unsat deduce t1 f =
  fold_left (fun pat e ->
    let acc,tg = pat in (match ror_clause unsat deduce t1 e with
                         | Inl cl -> (cl::acc),tg
...
let ror_clause_cnf unsat deduce t1 f =
  match t1 with
  | [] -> f,Null
  | _::_ -> xror_clause_cnf unsat deduce t1 f
...
let rec ror_cnf unsat deduce f f' =
  ...
  | [] -> cnf_tt,Null
  | e::rst ->
    let rst_f',t1 = ror_cnf unsat deduce rst f' in
    let e_f',t' = ror_clause_cnf unsat deduce e f' in (rev_append rst_f' e_f'),(Merge (t1, t'))

(** val ror_cnf_opt :
    ('a1 -> bool) -> ('a1 -> 'a1 -> 'a1 option) -> ('a1, 'a2) cnf -> ('a1, 'a2) cnf -> ('a1, 'a2) cnf * 'a2 trace **)

let ror_cnf_opt unsat deduce f1 f2 =
  if is_cnf_tt f1
  then cnf_tt,Null
  else if is_cnf_tt f2 then cnf_tt,Null else if is_cnf_ff f2 then f1,Null else ror_cnf unsat deduce f1 f2

(** val ratom : ('a1, 'a2) cnf -> 'a2 -> ('a1, 'a2) cnf * 'a2 trace **)

let ratom c a =
  if if is_cnf_ff c then true else is_cnf_tt c then c,(Push (a, Null)) else c,Null
...
let rxcnf_and unsat deduce rXCNF polarity k e1 e2 =
  ...
  else let f',t' = ror_cnf_opt unsat deduce e3 e4 in f',(Merge (t1, (Merge (t2, t'))))
...
let rxcnf_or unsat deduce rXCNF polarity k e1 e2 =
  ...
  let e4,t2 = rXCNF polarity k e2 in
  if polarity
  then let f',t' = ror_cnf_opt unsat deduce e3 e4 in f',(Merge (t1, (Merge (t2, t'))))
...
let rxcnf_impl unsat deduce rXCNF polarity k e1 e2 =
  ...
  then if is_cnf_tt e3
       then e3,t1
            ...
            else let e4,t2 = rXCNF polarity k e2 in let f',t' = ror_cnf_opt unsat deduce e3 e4 in f',(Merge (t1, (Merge (t2, t'))))
...
let rxcnf_iff unsat deduce rXCNF polarity k e1 e2 =
  ...
  let f',t' = ror_cnf_opt unsat deduce (and_cnf_opt c1 c2) (and_cnf_opt c3 c4) in
...
| X (_, _) -> cnf_ff,Null
| A (_, x, t1) -> ratom (if polarity then normalise1 x t1 else negate0 x t1) t1
| AND (k0, e1, e2) -> rxcnf_and unsat deduce (fun x x0 x1 -> rxcnf unsat deduce normalise1 negate0 x x0 x1) polarity k0 e1 e2
| OR (k0, e1, e2) -> rxcnf_or unsat deduce (fun x x0 x1 -> rxcnf unsat deduce normalise1 negate0 x x0 x1) polarity k0 e1 e2
| NOT (k0, e) -> rxcnf unsat deduce normalise1 negate0 (negb polarity) k0 e
| IMPL (k0, e1, _, e2) -> rxcnf_impl unsat deduce (fun x x0 x1 -> rxcnf unsat deduce normalise1 negate0 x x0 x1) polarity k0 e1 e2
| IFF (k0, e1, e2) -> rxcnf_iff unsat deduce (fun x x0 x1 -> rxcnf unsat deduce normalise1 negate0 x x0 x1) polarity k0 e1 e2
| EQ (e1, e2) -> rxcnf_iff unsat deduce (fun x x0 x1 -> rxcnf unsat deduce normalise1 negate0 x x0 x1) polarity IsBool e1 e2
...
| X (_, p) -> p
| A (b, x, t1) -> to_constr.mkA b x t1
| AND (k0, f1, f2) -> to_constr.mkAND k0 (aformula to_constr k0 f1) (aformula to_constr k0 f2)
| OR (k0, f1, f2) -> to_constr.mkOR k0 (aformula to_constr k0 f1) (aformula to_constr k0 f2)
| NOT (k0, f0) -> to_constr.mkNOT k0 (aformula to_constr k0 f0)
| IMPL (k0, f1, _, f2) -> to_constr.mkIMPL k0 (aformula to_constr k0 f1) (aformula to_constr k0 f2)
| IFF (k0, f1, f2) -> to_constr.mkIFF k0 (aformula to_constr k0 f1) (aformula to_constr k0 f2)
| EQ (f1, f2) -> to_constr.mkEQ (aformula to_constr IsBool f1) (aformula to_constr IsBool f2)
...
(** val mk_arrow :
    'a4 option -> kind -> ('a1, 'a2, 'a3, 'a4) tFormula -> ('a1, 'a2, 'a3, 'a4) tFormula -> ('a1, 'a2, 'a3, 'a4) tFormula **)

let mk_arrow o k f1 f2 =
  match o with
  | Some _ -> (match is_X k f1 with
               | Some _ -> f2
               | None -> IMPL (k, f1, o, f2))
...
| A (k, x, t1) -> if needA t1 then A (k, x, t1) else X (k, (to_constr.mkA k x t1))
| AND (k0, f1, f2) -> AND (k0, (abst_simpl to_constr needA k0 f1), (abst_simpl to_constr needA k0 f2))
| OR (k0, f1, f2) -> OR (k0, (abst_simpl to_constr needA k0 f1), (abst_simpl to_constr needA k0 f2))
| NOT (k0, f0) -> NOT (k0, (abst_simpl to_constr needA k0 f0))
| IMPL (k0, f1, o, f2) -> IMPL (k0, (abst_simpl to_constr needA k0 f1), o, (abst_simpl to_constr needA k0 f2))
| IFF (k0, f1, f2) -> IFF (k0, (abst_simpl to_constr needA k0 f1), (abst_simpl to_constr needA k0 f2))
| EQ (f1, f2) -> EQ ((abst_simpl to_constr needA IsBool f1), (abst_simpl to_constr needA IsBool f2))
| x -> x
...
let abst_and to_constr rEC pol0 k f1 f2 =
  if pol0
  then abs_and to_constr k (rEC pol0 k f1) (rEC pol0 k f2) (fun x x0 x1 -> AND (x, x0, x1))
  else abs_or to_constr k (rEC pol0 k f1) (rEC pol0 k f2) (fun x x0 x1 -> AND (x, x0, x1))
...
let abst_or to_constr rEC pol0 k f1 f2 =
  if pol0
  then abs_or to_constr k (rEC pol0 k f1) (rEC pol0 k f2) (fun x x0 x1 -> OR (x, x0, x1))
  else abs_and to_constr k (rEC pol0 k f1) (rEC pol0 k f2) (fun x x0 x1 -> OR (x, x0, x1))
...
let abs_iff to_constr k nf1 ff2 f1 tf2 r def =
  if (&&) (or_is_X k nf1 ff2) (or_is_X k f1 tf2) then X (r, (aformula to_constr r def)) else def
...
let abst_iff to_constr needA rEC pol0 k f1 f2 =
  abs_iff to_constr k (rEC (negb pol0) k f1) (rEC false k f2) (rEC pol0 k f1) (rEC true k f2) k (IFF (k,
    (abst_simpl to_constr needA k f1), (abst_simpl to_constr needA k f2)))
...
let abst_eq to_constr needA rEC pol0 f1 f2 =
  abs_iff to_constr IsBool (rEC (negb pol0) IsBool f1) (rEC false IsBool f2) (rEC pol0 IsBool f1) (rEC true IsBool f2) IsProp (EQ
    ((abst_simpl to_constr needA IsBool f1), (abst_simpl to_constr needA IsBool f2)))
...
| X (k, p) -> X (k, p)
| A (k, x, t1) -> if needA t1 then A (k, x, t1) else X (k, (to_constr.mkA k x t1))
| AND (k0, f1, f2) -> abst_and to_constr (abst_form to_constr needA) pol0 k0 f1 f2
| OR (k0, f1, f2) -> abst_or to_constr (abst_form to_constr needA) pol0 k0 f1 f2
| NOT (k0, f0) -> abs_not to_constr k0 (abst_form to_constr needA (negb pol0) k0 f0) (fun x x0 -> NOT (x, x0))
| IMPL (k0, f1, o, f2) -> abst_impl to_constr (abst_form to_constr needA) pol0 o k0 f1 f2
| IFF (k0, f1, f2) -> abst_iff to_constr needA (abst_form to_constr needA) pol0 k0 f1 f2
| EQ (f1, f2) -> abst_eq to_constr needA (abst_form to_constr needA) pol0 f1 f2
...
let nformula_times_nformula cO cI cplus ctimes ceqb f1 f2 =
  let e1,o1 = f1 in let e2,o2 = f2 in map_option (fun x -> Some ((pmul cO cI cplus ctimes ceqb e1 e2),x)) (opMult o1 o2)

(** val nformula_plus_nformula :
    'a1 -> ('a1 -> 'a1 -> 'a1) -> ('a1 -> 'a1 -> bool) -> 'a1 nFormula -> 'a1 nFormula -> 'a1 nFormula option **)

let nformula_plus_nformula cO cplus ceqb f1 f2 =
  let e1,o1 = f1 in let e2,o2 = f2 in map_option (fun x -> Some ((padd cO cplus ceqb e1 e2),x)) (opAdd o1 o2)
...
| PsatzMulC (re, e0) -> map_option (pexpr_times_nformula cO cI cplus ctimes ceqb re) (eval_Psatz cO cI cplus ctimes ceqb cleb l e0)
| PsatzMulE (f1, f2) ->
  map_option2 (nformula_times_nformula cO cI cplus ctimes ceqb) (eval_Psatz cO cI cplus ctimes ceqb cleb l f1)
    (eval_Psatz cO cI cplus ctimes ceqb cleb l f2)
| PsatzAdd (f1, f2) ->
  map_option2 (nformula_plus_nformula cO cplus ceqb) (eval_Psatz cO cI cplus ctimes ceqb cleb l f1)
    (eval_Psatz cO cI cplus ctimes ceqb cleb l f2)
...
let cnf_of_list cO ceqb cleb l tg =
  fold_right (fun x acc -> if check_inconsistent cO ceqb cleb x then acc else ((x,tg)::[])::acc) cnf_tt l

(** val cnf_normalise :
    'a1 -> 'a1 -> ('a1 -> 'a1 -> 'a1) -> ('a1 -> 'a1 -> 'a1) -> ('a1 -> 'a1 -> 'a1) -> ('a1 -> 'a1) -> ('a1 -> 'a1 -> bool) -> ('a1
    -> 'a1 -> bool) -> 'a1 formula -> 'a2 -> ('a1 nFormula, 'a2) cnf **)

let cnf_normalise cO cI cplus ctimes cminus copp ceqb cleb t1 tg =
  let f = normalise cO cI cplus ctimes cminus copp ceqb t1 in
  if check_inconsistent cO ceqb cleb f then cnf_ff else cnf_of_list cO ceqb cleb (xnormalise copp f) tg

(** val cnf_negate :
    'a1 -> 'a1 -> ('a1 -> 'a1 -> 'a1) -> ('a1 -> 'a1 -> 'a1) -> ('a1 -> 'a1 -> 'a1) -> ('a1 -> 'a1) -> ('a1 -> 'a1 -> bool) -> ('a1
    -> 'a1 -> bool) -> 'a1 formula -> 'a2 -> ('a1 nFormula, 'a2) cnf **)

let cnf_negate cO cI cplus ctimes cminus copp ceqb cleb t1 tg =
  let f = normalise cO cI cplus ctimes cminus copp ceqb t1 in
  if check_inconsistent cO ceqb cleb f then cnf_tt else cnf_of_list cO ceqb cleb (xnegate copp f) tg
...
| PX (p2, j, q0) -> PEadd ((PEmul ((xdenorm jmp p2), (PEpow ((PEX jmp), (Npos j))))), (xdenorm (Coq_Pos.succ jmp) q0))
...
let map_Formula c_of_S f =
  let { flhs = l; fop = o; frhs = r } = f in { flhs = (map_PExpr c_of_S l); fop = o; frhs = (map_PExpr c_of_S r) }

(** val simpl_cone : 'a1 -> 'a1 -> ('a1 -> 'a1 -> 'a1) -> ('a1 -> 'a1 -> bool) -> 'a1 psatz -> 'a1 psatz **)

let simpl_cone cO cI ctimes ceqb e = match e with
| PsatzSquare t1 -> (match t1 with
  ...
  (match t1 with
   ...
   | PsatzC c ->
     (match t2 with
      ...
      | PsatzAdd (y, z0) -> PsatzAdd ((PsatzMulE ((PsatzC c), y)), (PsatzMulE ((PsatzC c), z0)))
...
let rec xis_integral e jmp = function
| Pc _ -> true
| Pinj (j, p2) -> xis_integral e (Coq_Pos.add j jmp) p2
| PX (p2, _, q0) -> (&&) ((&&) (xis_integral e jmp p2) (e jmp)) (xis_integral e (Coq_Pos.succ jmp) q0)
...
let oget s x =
  match s with
  | Some s0 -> PositiveSet.mem x s0
  | None -> true

(** val is_integral : PositiveSet.t option -> z pol -> bool **)

let is_integral e pol0 =
  match e with
  | Some e0 -> xis_integral (get e0) XH pol0
  | None -> true

(** val ceiling : z -> z -> z **)

let ceiling a b =
  let q0,r = Z.div_eucl a b in (match r with
                                | Z0 -> q0
                                | _ -> Z.add q0 (Zpos XH))
...
| PX (p2, _, q0) -> let g1,c1 = zgcd_pol p2 in let g2,c2 = zgcd_pol q0 in (zgcdM (zgcdM g1 c1) g2),c2
...
let makeCuttingPlane p =
  let g,c = zgcd_pol p in if Z.gtb g Z0 then (zdiv_pol (psubC Z.sub p c) g),(Z.opp (ceiling (Z.opp c) g)) else p,Z0
...
| e,op ->
  (match op with
   | Equal ->
     ...
     if (&&) (Z.gtb g Z0) ((&&) (negb (Z.eqb c Z0)) (negb (Z.eqb (Z.gcd g c) g))) then None else Some ((makeCuttingPlane e),Equal)
...
let mk_eq_pos x y t1 =
  { flhs = (PEX x); fop = OpEq; frhs = (PEsub ((PEX y), (PEX t1))) }
...
| PX (p2, _, q0) -> Coq_Pos.max (max_var jmp p2) (max_var (Coq_Pos.succ jmp) q0)
...
let add0 x = function
| Some s0 -> Some (PositiveSet.add x s0)
| None -> None

(** val zChecker : PositiveSet.t option -> z nFormula list -> zArithProof -> bool **)

let rec zChecker is_integer l = function
| DoneProof -> false
| RatProof (w, pf0) ->
  (match eval_Psatz0 l w with
   | Some f -> if zunsat f then true else zChecker is_integer (f::l) pf0
   | None -> false)
| CutProof (w, pf0) ->
  (match eval_Psatz0 l w with
   | Some f ->
     if is_integral is_integer (fst f)
     then (match genCuttingPlane f with
           | Some cp -> zChecker is_integer ((nformula_of_cutting_plane cp)::l) pf0
           | None -> true)
     else false
   | None -> false)
| SplitProof (p, pf1, pf2) ->
  if is_integral is_integer p
  then (match genCuttingPlane (p,NonStrict) with
        | Some cp1 ->
   ...
   | Some f1 ->
     (match eval_Psatz0 l w2 with
      | Some f2 ->
        ...
        then (match genCuttingPlane f1 with
              | Some p ->
                let p2,op3 = p in
                let e1,z1 = p2 in
                (match genCuttingPlane f2 with
                 | Some p3 ->
                   let p4,op4 = p3 in
                   let e2,z2 = p4 in
                   if (&&) ((&&) (valid_cut_sign op3) (valid_cut_sign op4)) (is_pol_Z0 (padd1 e1 e2))
                   then let rec label pfs lb ub =
                          match pfs with
                          | [] -> Z.gtb lb ub
                          | pf1::rsr ->
                            (&&) (zChecker is_integer (((psub1 e1 (Pc lb)),Equal)::l) pf1) (label rsr (Z.add lb (Zpos XH)) ub)
...
| ExProof (x, prf) ->
  ...
  if (&&) (Coq_Pos.leb x fr) (oget is_integer x)
  then let z0 = Coq_Pos.succ fr in
       let t1 = Coq_Pos.succ z0 in
       let nfx = xnnormalise (mk_eq_pos x z0 t1) in
       let posz = xnnormalise (bound_var z0) in
       let post = xnnormalise (bound_var t1) in zChecker (add0 z0 (add0 t1 is_integer)) (nfx::(posz::(post::l))) prf
  else false
...
| PEc c -> Some c
| PEX _ -> None
| PEadd (e1, e2) -> map_option2 (fun x y -> Some (Z.add x y)) (zeval_const e1) (zeval_const e2)
| PEsub (e1, e2) -> map_option2 (fun x y -> Some (Z.sub x y)) (zeval_const e1) (zeval_const e2)
| PEmul (e1, e2) -> map_option2 (fun x y -> Some (Z.mul x y)) (zeval_const e1) (zeval_const e2)
| PEopp e0 -> map_option (fun x -> Some (Z.opp x)) (zeval_const e0)
| PEpow (e1, n0) -> map_option (fun x -> Some (Z.pow x (Z.of_N n0))) (zeval_const e1)
...
let cnf_of_list0 tg l =
  fold_right (fun x acc -> if zunsat x then acc else ((x,tg)::[])::acc) cnf_tt l
...
| e,o ->
  (match o with
   | Equal -> ((psub1 e (Pc (Zpos XH))),NonStrict)::(((psub1 (Pc (Zneg XH)) e),NonStrict)::[])
   | NonEqual -> (e,Equal)::[]
...
let normalise0 t1 tg =
  let f = xnnormalise t1 in if zunsat f then cnf_ff else cnf_of_list0 tg (xnormalise0 f)
...
| e,o ->
  (match o with
   | NonEqual -> ((psub1 e (Pc (Zpos XH))),NonStrict)::(((psub1 (Pc (Zneg XH)) e),NonStrict)::[])
...
let negate t1 tg =
  let f = xnnormalise t1 in if zunsat f then cnf_tt else cnf_of_list0 tg (xnegate0 f)
...
let zTautoChecker f w =
  tauto_checker zunsat zdeduce normalise0 negate (fun cl -> zChecker None (map fst cl)) f w
...
let qWeakChecker =
  check_normalised_formulas { qnum = Z0; qden = XH } { qnum = (Zpos XH); qden = XH } qplus qmult qeq_bool qle_bool

(** val qnormalise : q formula -> 'a1 -> (q nFormula, 'a1) cnf **)

let qnormalise t1 tg =
  cnf_normalise { qnum = Z0; qden = XH } { qnum = (Zpos XH); qden = XH } qplus qmult qminus qopp qeq_bool qle_bool t1 tg

(** val qnegate : q formula -> 'a1 -> (q nFormula, 'a1) cnf **)

let qnegate t1 tg =
  cnf_negate { qnum = Z0; qden = XH } { qnum = (Zpos XH); qden = XH } qplus qmult qminus qopp qeq_bool qle_bool t1 tg
...
let normQ =
  norm { qnum = Z0; qden = XH } { qnum = (Zpos XH); qden = XH } qplus qmult qminus qopp qeq_bool
...
let qTautoChecker f w =
  tauto_checker qunsat qdeduce qnormalise qnegate (fun cl -> qWeakChecker (map fst cl)) f w
...
let map_eFormula f = function
| IsZ (b, x) -> IsZ (b, x)
| IsF f1 -> IsF (map_Formula f f1)

(** val lcm0 : q pol -> z **)

let rec lcm0 = function
| Pc q0 -> Zpos q0.qden
| Pinj (_, p2) -> lcm0 p2
| PX (p2, _, q0) -> Z.lcm (lcm0 p2) (lcm0 q0)

(** val polZ : z -> q pol -> z pol **)

let rec polZ lcm1 = function
| Pc q0 -> Pc (Z.div (Z.mul q0.qnum lcm1) (Zpos q0.qden))
| Pinj (x, p2) -> Pinj (x, (polZ lcm1 p2))
| PX (p2, i, q0) -> PX ((polZ lcm1 p2), i, (polZ lcm1 q0))

(** val nformulaZ : q nFormula -> z nFormula **)

let nformulaZ = function
| p,o -> (polZ (lcm0 p) p),o
...
| p::l0 ->
  let e,_ = p in
  (match e with
   | IsZ (b, x) -> xcollect_isZ (if b then PositiveSet.add x s else s) acc l0
   | IsF f -> xcollect_isZ s ((nformulaZ f)::acc) l0)

(** val qCheck : (q nFormula eFormula * unit0) list -> zArithProof -> bool **)

let qCheck l =
  let s,cl = xcollect_isZ PositiveSet.empty [] l in zChecker (Some s) cl

(** val erunsat : q nFormula eFormula -> bool **)

let erunsat = function
| IsZ (_, _) -> false
| IsF f0 -> runsat f0
...
let erdeduce f1 f2 =
  match f1 with
  | IsZ (_, _) -> None
  | IsF f3 -> (match f2 with
               | IsZ (_, _) -> None
               | IsF f4 -> (match rdeduce f3 f4 with
                            | Some f -> Some (IsF f)
                            | None -> None))
...
let map_cnf f l =
  map (map (fun pat -> let a,t1 = pat in (f a),t1)) l

(** val eRnormalise : q formula eFormula -> 'a1 -> (q nFormula eFormula, 'a1) cnf **)

let eRnormalise f t1 =
  match f with
  | IsZ (b, z0) -> (((IsZ ((negb b), z0)),t1)::[])::[]
  | IsF f0 -> map_cnf (fun x -> IsF x) (rnormalise f0 t1)

(** val eRnegate : q formula eFormula -> 'a1 -> (q nFormula eFormula, 'a1) cnf **)

let eRnegate f t1 =
  match f with
  | IsZ (b, z0) -> (((IsZ (b, z0)),t1)::[])::[]
  | IsF f0 -> map_cnf (fun x -> IsF x) (rnegate f0 t1)

(** val cnfR : kind -> (q formula eFormula, 'a1, 'a2, 'a3) tFormula -> (q nFormula eFormula, 'a1) cnf * 'a1 trace **)

let cnfR k f =
  rxcnf erunsat erdeduce eRnormalise eRnegate true k f

(** val rTautoChecker : rcst formula eFormula bFormula -> rWitness list -> bool **)

let rTautoChecker f w =
  tauto_checker erunsat erdeduce eRnormalise eRnegate qCheck (map_bformula IsProp (map_eFormula q_of_Rcst) f) w
