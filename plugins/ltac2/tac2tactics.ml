...
let congruence n l = Cc_plugin.Cctac.congruence_tac n (Option.default [] l)

let simple_congruence n l = Cc_plugin.Cctac.simple_congruence_tac n (Option.default [] l)
