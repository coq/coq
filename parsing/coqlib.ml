...
let nat_path = make_ln (MPcomp datatypes_module) (label_of_string "nat") 
let myvar_path =
  make_ln (MPcomp arith_module) (label_of_string "My_special_variable") 
...
let eq_path = make_ln (MPcomp logic_module) (label_of_string "eq")
let eqT_path = make_ln (MPcomp logic_type_module) (label_of_string "eqT")
