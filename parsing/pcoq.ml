...
| GramExtByEntryName : int * ('a Entry.t * 'a extend_statement) -> grammar_entry
...
| GramExtByEntryName (_, (e,ext)) -> grammar_extend e ext
...
| [] -> accu
| ((GramExt (p, _) | EntryExt (p, _, _) | GramExtByEntryName (p, _)), _) :: rem ->
