...
: "${new_coq_opam_archive_git_uri:=https://github.com/ppedrot/opam-coq-archive.git}"
: "${old_coq_opam_archive_git_uri:=https://github.com/ppedrot/opam-coq-archive.git}"
: "${new_coq_opam_archive_git_branch:=experiment-equations-build-term-nocheck}"
: "${old_coq_opam_archive_git_branch:=fix-metacoq-shim-deps}"
: "${num_of_iterations:=1}"
: "${timeout:=3h}"
: "${coq_opam_packages:=coq-metacoq-template coq-metacoq-pcuic coq-metacoq-safechecker coq-metacoq-erasure coq-metacoq-translations}"
