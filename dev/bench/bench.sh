...
: "${new_coq_opam_archive_git_branch:=bench-elpi-demote}"
: "${old_coq_opam_archive_git_branch:=master}"
: "${new_coq_version:=dev}"
: "${old_coq_version:=dev}"
: "${num_of_iterations:=1}"
: "${timeout:=3h}"
: "${coq_opam_packages:=coq-elpi.dev coq-bignums coq-mathcomp-ssreflect coq-mathcomp-fingroup coq-mathcomp-algebra coq-mathcomp-solvable coq-mathcomp-field coq-mathcomp-character coq-mathcomp-odd-order coq-mathcomp-finmap coq-mathcomp-classical coq-mathcomp-bigenough coq-mathcomp-analysis}"
: "${coq_native:=}"
