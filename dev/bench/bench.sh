...
: "${num_of_iterations:=1}"
: "${timeout:=3h}"
: "${coq_opam_packages:=coq-flocq coq-fiat-core coq-color coq-verdi coq-corn coq-verdi-raft coq-math-classes coq-fiat-parsers coq-coquelicot coq-iris-examples}"
: "${coq_native:=}"
: "${skip_coq_tests:=1}"
