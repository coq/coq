...
val autorewrite : unit Proofview.tactic -> string list -> unit Proofview.tactic
val autorewrite_in : Names.Id.t -> unit Proofview.tactic -> string list -> unit Proofview.tactic
