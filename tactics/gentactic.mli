...
val of_genarg : Genarg.raw_generic_argument -> raw_generic_tactic
(** The genarg must have registrations for all the following APIs. *)

val print_raw : Environ.env -> Evd.evar_map -> raw_generic_tactic -> Pp.t

val print_glob : Environ.env -> Evd.evar_map -> glob_generic_tactic -> Pp.t
