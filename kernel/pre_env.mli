...
val push_named_context_val_val  :
    Context.Named.Declaration.t -> lazy_val -> private_flag -> named_context_val -> named_context_val
val match_named_context_val  :
  named_context_val -> (Context.Named.Declaration.t * lazy_val * private_flag * named_context_val) option
val map_named_val :
