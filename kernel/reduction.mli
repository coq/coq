...
val infer_conv : ?l2r:bool -> ?evars:(cexistential->constr option) ->
  ?ts:TransparentState.t -> constr infer_conversion_function
val infer_conv_leq : ?l2r:bool -> ?evars:(cexistential->constr option) ->
...
(** Depending on the universe state functions, this might raise
  ...
  messages). *)
val generic_conv : conv_pb -> l2r:bool -> (cexistential->constr option) ->
