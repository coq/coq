...
let hcons_rel_decl =
  RelDecl.map_name Names.Name.hcons %> RelDecl.map_value Constr.Internal.hcons %> RelDecl.map_type Constr.Internal.hcons
...
let hcons_const_body cb =
  { cb with
    ...
    const_type = Constr.Internal.hcons cb.const_type;
