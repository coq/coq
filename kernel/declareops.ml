...
let hcons_rel_decl =
  RelDecl.map_name Names.Name.hcons %> RelDecl.map_value Constr.Internal.hcons_constr %> RelDecl.map_type Constr.Internal.hcons_types
...
let hcons_const_def = function
  ...
  | Def l_constr ->
    ...
    Def (from_val (Constr.Internal.hcons constr))
...
let hcons_const_body cb =
  { cb with
    ...
    const_type = Constr.Internal.hcons_constr cb.const_type;
...
let hcons_regular_ind_arity a =
  { mind_user_arity = Constr.Internal.hcons a.mind_user_arity;
...
let hcons_mind_packet oib =
  let user = Array.smartmap Constr.Internal.hcons oib.mind_user_lc in
  let nf = Array.smartmap Constr.Internal.hcons oib.mind_nf_lc in
