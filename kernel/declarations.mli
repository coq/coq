...
type pattern =
  | PRel     of int
  | PSort    of (Sorts.QVar.t * bool, Univ.Level.t * bool) sort_pattern
  ...
  | PProd    of Name.t * arg_pattern * (Sorts.QVar.t * Univ.Level.t) * arg_pattern * (Sorts.QVar.t * Univ.Level.t)
  ...
  | PProj    of pattern * Projection.t * (Sorts.QVar.t array * Univ.Level.t array * Evar.t array)
