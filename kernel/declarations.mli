...
val constant_polymorphic_context : constant_body -> Univ.AUContext.t

(** Is the constant polymorphic? *)
val constant_is_polymorphic : constant_body -> bool

val subst_const_body : Mod_subst.substitution -> constant_body -> constant_body
...
val subst_recarg : Mod_subst.substitution -> recarg -> recarg
...
val subst_wf_paths : Mod_subst.substitution -> wf_paths -> wf_paths
...
val inductive_polymorphic_context : mutual_inductive_body -> Univ.AUContext.t

val subst_mind_body : Mod_subst.substitution -> mutual_inductive_body -> mutual_inductive_body
