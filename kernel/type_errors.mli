...
type ('constr, 'types) ptype_error =
  ...
  | UnsatisfiedSizeConstraints of Sized.Constraints.t * 'constr * Sized.SVars.t * Sized.SVars.t
...
val error_unsatisfied_size_constraints : env -> Sized.Constraints.t -> constr -> Sized.SVars.t -> Sized.SVars.t -> 'a
