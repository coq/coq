...
| SReloc_Const_quality of Sorts.Quality.t
| SReloc_Const_univ_level of Univ.Level.t
...
| SReloc_Const_quality q -> Reloc_const (Const_quality q)
| SReloc_Const_univ_level l -> Reloc_const (Const_univ_level l)
...
let to_memory fv code =
  ...
  let map (_, r) =
    ...
    | Reloc_const (Const_quality q) -> push (SReloc_Const_quality q)
    | Reloc_const (Const_univ_level l) -> push (SReloc_Const_univ_level l)
