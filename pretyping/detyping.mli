...
val detype : 'a delay -> ?lax:bool -> ?isgoal:bool -> Id.Set.t -> env -> evar_map -> constr -> 'a glob_constr_g
...
val detype_closed_glob : ?lax:bool -> ?isgoal:bool -> Id.Set.t -> env -> evar_map -> closed_glob_constr -> glob_constr
