...
type typeclass = {
  ...
  cl_context : (GlobRef.t * bool) option list * Context.Rel.t;
...
val declare_instance : Vernacexpr.hint_info_expr option -> bool -> GlobRef.t -> unit
...
val build_subclasses : check:bool -> env -> evar_map -> GlobRef.t ->
		       ...
		       (GlobRef.t list * Vernacexpr.hint_info_expr * constr) list
