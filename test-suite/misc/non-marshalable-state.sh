...
RC=1
# must fail
coqc_stm -async-proofs on  -I src -Q theories Marshal theories/evil.v 2> log1 1>&2 || RC=0
#   for this reason
grep -q 'Marshalling error' log1 || RC=1

# must work
coqc_stm -async-proofs off -I src -Q theories Marshal theories/evil.v

# must work
coqc_stm -async-proofs on  -I src -Q theories Marshal theories/good.v
