...
Goal P a.(p). unfold p. cbv delta [a]. kred. Show. Abort.  (* -> 0 *)
...
Goal P a.(p). unfold p. cbv delta [a]. kred. Show. Abort.  (* -> {| p := 0 |}.(p) *)
Goal P a.(p). unfold p. cbv delta [a]. hnf. Show. Abort.   (* -> 0 *)
End DirectTuple.
...
Goal P a.(p). unfold p. kred. Show. Abort.  (* -> 0 *)
...
Goal P a.(q). unfold q. cbv delta [a]. kred. Show. Abort.  (* -> COFIX *)
...
Goal P a.(q). unfold q. cbv delta [a]. kred. Show. Abort.  (* -> COFIX.(q) *)
Goal P a.(q). unfold q. cbv delta [a]. hnf. Show. Abort.   (* -> COFIX *)
End DirectCoFix.
...
Goal P a.(q). unfold q. kred. Show. Abort.   (* -> a.(q) *)
Goal P a.(q). unfold q. hnf. Show. Abort.    (* -> a.(q) *) (* bug primproj 4 *)
...
Goal P (id p a). unfold id. cbv delta [a]. kred. Show. Abort.  (* -> 0 *)
...
Goal P (id p a). unfold id. cbv delta [a]. kred. Show. Abort.  (* -> TUPLE.(p) *)
Goal P (id p a). unfold id. cbv delta [a]. hnf. Show. Abort.   (* -> TUPLE.(p) *) (* bug primproj 1 *)
End DirectTuple.
...
Goal P (id p a). unfold id. kred. Show. Abort.  (* -> 0 *)
...
Goal P (id q COFIX). unfold id. kred. Show. Abort.   (* -> COFIX *)
...
Goal P (id q COFIX). unfold id. kred. Show. Abort.   (* -> COFIX.(q) *)
Goal P (id q COFIX). unfold id. hnf. Show. Abort.    (* -> COFIX.(q) *) (* bug primproj 3 *)
End DirectCoFix.
...
Goal P (id q a). unfold id. kred. Show. Abort.   (* -> a *)
...
Goal P (id q a). unfold id. kred. Show. Abort.   (* -> a.(q) *)
Goal P (id q a). unfold id. hnf. Show. Abort.    (* -> a.(q) *) (* bug primproj 4 *)
Arguments q : simpl nomatch.
Arguments a : simpl never.
