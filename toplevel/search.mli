...
val search_by_head : int option -> constr_pattern -> DirPath.t list * bool -> std_ppcmds list
val search_rewrite : int option -> constr_pattern -> DirPath.t list * bool -> std_ppcmds list
val search_pattern : int option -> constr_pattern -> DirPath.t list * bool -> std_ppcmds list
val search_about   : int option -> (bool * glob_search_about_item) list
  -> DirPath.t list * bool -> std_ppcmds list
