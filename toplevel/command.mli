...
val declare_assumption : identifier -> assumption_kind -> Coqast.t -> global_reference
...
val start_proof_com : identifier option -> goal_kind -> Coqast.t -> Proof_type.declaration_hook -> unit
