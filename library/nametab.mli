...
val push : ?user_warns:Globnames.extended_global_reference UserWarn.t -> visibility -> full_path -> GlobRef.t -> unit
...
val push_abbreviation : ?user_warns:Globnames.extended_global_reference UserWarn.t -> visibility -> full_path -> Globnames.abbreviation -> unit

val push_universe : visibility -> full_path -> Univ.UGlobal.t -> unit

(** Deprecation and user warn info *)

val is_warned_xref : Globnames.extended_global_reference -> Globnames.extended_global_reference UserWarn.t option

val warn_user_warn_xref : ?loc:Loc.t -> Globnames.extended_global_reference UserWarn.t -> Globnames.extended_global_reference -> unit
